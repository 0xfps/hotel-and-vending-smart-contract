...
contract HAV {
    ...
    /*
    * @dev: Makes sure the `_address` has a room already in the hotel.
    */
    ...
    /*
    * @dev: Checks if `_address` is allowed to access a room.
    */
    ...
    /*
    * @dev: Grants `msg.sender` access to a room and he sets his password.
    */
    ...
    /*
    * @dev: Grants `msg.sender` access to book a room for `_address` and he sets his password.
    */
    ...
    /*
    * @dev: Unlocks your door.
    * `msg.sender` must be approved or own the room.
    */
    function unlock(address _address, string memory _key) public isValidSender {
    ...
    * `msg.sender` must be approved or own the room.
    */
    function lock(address _address) public isValidSender {
        require(hasRoom(_address), "! Booked");
    ...
    /*
    * @dev:  Approves `address` to access `msg.sender`'s room.
    */
    ...
    /*
    * @dev: Revokes `address` to access `msg.sender`'s room.
    */
    ...
    /*
    * @dev: Leave, says bye to the hotel.
    */
    ...
    /*
    * @dev: Sees the owner of the room
    */
